...
namespace WPFAccessibility.Test.UITests
{
    [TestFixture]
    public class WPFAccessibilityTest
    {
        ...
        public void SetUp()
        {
            var psi = new ProcessStartInfo(@".\..\..\..\..\WPFAccessibility\bin\Debug\WPFAccessibility.exe")
            {
        ...
        public void TestThatCustomButtonControlTextAlignStateCanBeRead()
        {
            ...
            // Verify TextAlign
            Assert.IsTrue(customButton.CurrentHelpText.Contains("HorizontalAlignment=Left;VerticalAlignment=Top"));
        }
    }
}
